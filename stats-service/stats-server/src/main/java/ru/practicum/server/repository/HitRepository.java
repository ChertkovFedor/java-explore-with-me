...
public interface HitRepository extends JpaRepository<Hit, Long> {
    ...
    List<ViewStatsDto> getStats(LocalDateTime start, LocalDateTime end, Collection<String> uris);
    ...
    @Query("SELECT new ru.practicum.dto.ViewStatsDto(e.app, e.uri, COUNT(distinct e.ip)) " +
            ...
            " AND e.uri IN :uris" +
            " GROUP BY e.app, e.uri")
    List<ViewStatsDto> getStatsUniqueIps(LocalDateTime start, LocalDateTime end, Collection<String> uris);
